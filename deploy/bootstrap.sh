...
SQLITE_WRITE_BATCH_SIZE_VALUE="${SQLITE_WRITE_BATCH_SIZE:-64}"
SQLITE_WRITE_QUEUE_LIMIT_VALUE="${SQLITE_WRITE_QUEUE_LIMIT:-4096}"
SQLITE_WRITE_BATCH_WINDOW_MS_VALUE="${SQLITE_WRITE_BATCH_WINDOW_MS:-4}"
...
if [[ ! -f .env ]]; then
  ...
  install -m 600 /dev/null .env
  {
    ...
    echo "SQLITE_WRITE_BATCH_SIZE=${SQLITE_WRITE_BATCH_SIZE_VALUE}"
    echo "SQLITE_WRITE_QUEUE_LIMIT=${SQLITE_WRITE_QUEUE_LIMIT_VALUE}"
    echo "SQLITE_WRITE_BATCH_WINDOW_MS=${SQLITE_WRITE_BATCH_WINDOW_MS_VALUE}"
