...
[在线入口](https://choice.example.com/) · [学生端操作说明](docs/manuals/student-guide.md) · [管理端操作说明](docs/manuals/admin-guide.md) · [部署手册](docs/deployment.md) · [并发架构](docs/architecture.md) · [安全说明](SECURITY.md)
