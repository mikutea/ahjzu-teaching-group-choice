...
(async () => {
  ...
  newActivityRow._capacityInput.value = newActivityRow.dataset.originalCapacity;
  ...
  delayedNewActivityRow._capacityInput.value = delayedNewActivityRow.dataset.originalCapacity;
