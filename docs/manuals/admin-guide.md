...
**活动准备 · 候场确认 · 统一倒计时 · 实时大屏 · 结果导出**

适用角色：学院授权管理教师　｜　推荐主控：4K 电脑 + 投影/大屏　｜　辅助：手机管理端
...
| 角色 | 建议设备 | 主要任务 |
| --- | --- | --- |
| 主控教师 | 电脑连接教室投影或 4K 大屏 | 登录、准备检查、倒计时、开放/关闭、观察实时大屏 |
...
<p align="center"><img src="images/admin/admin-01-login.png" alt="4K 管理员登录页面，演示数据" width="1200"></p>
<p align="center"><sub>图 1　4K 管理端登录页；正式环境应使用 HTTPS，浏览器地址必须与学院公布域名一致。</sub></p>
...
<p align="center"><img src="images/admin/admin-04-structure-and-quotas.png" alt="4K 专业、教学组和配额矩阵页面，演示数据" width="1200"></p>
<p align="center"><sub>图 2　专业、教学组和配额矩阵在同一 4K 工作区中完成；截图数据均为虚构。</sub></p>
...
<p align="center"><img src="images/admin/admin-05-roster-import.png" alt="4K 学生名单导入页面，演示数据" width="1200"></p>
...
<p align="center"><img src="images/admin/admin-06-activation-query.png" alt="4K 激活码查询页面，演示数据" width="1200"></p>
...
<p align="center"><img src="images/admin/admin-07-waiting-dashboard.png" alt="4K 候场实时大屏，演示数据" width="1200"></p>
...
<p align="center"><img src="images/admin/admin-08-countdown-confirmation.png" alt="4K 未进入候场学生确认窗口，演示数据" width="1200"></p>
...
<p align="center"><img src="images/admin/admin-09-countdown.png" alt="4K 全屏统一倒计时，演示数据" width="1200"></p>
<p align="center"><sub>图 7　4K 全屏倒计时；开放时刻由服务器保存的绝对时间决定。</sub></p>

## 八、开放期间监控实时大屏

倒计时归零后系统自动开放。普通管理页集中显示教学组名额、选择流水、二维码、已选/未选人数、总体完成率和未选名单。

<p align="center"><img src="images/admin/admin-02-live-dashboard.png" alt="4K 抢选进行中管理面板，演示数据" width="1200"></p>
<p align="center"><sub>图 8　进行中管理面板用于主控操作和最近选择记录核对。</sub></p>

点击 **“进入实时大屏”** 或 **“全屏展示”** 后，可投放到教室屏幕。列表采用连续滚动方式展示，二维码位于中间主视觉区域。

<p align="center"><img src="images/admin/admin-03-fullscreen-board.png" alt="4K 全屏实时大屏，演示数据" width="1200"></p>
<p align="center"><sub>图 9　4K 全屏实时大屏：左侧教学组与选择流水，中间二维码，右侧总体进度和未选学生。</sub></p>
